        ...
        describe("DateInRegionInterval") {
            ...
            context("initialisation") {
                ...
                it("start & end") {
                    ...
                    let dateInterval = DateInRegionInterval(start: startDate, end: endDate)
                ...
                it("interval") {
                    ...
                    let dateInterval = DateInRegionInterval(start: startDate, interval: interval)
                    expect(dateInterval).toNot(beNil())
                    expect(dateInterval.start) == startDate
